    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (respuesta.statusCode() == 200) {
                ...
                System.out.println("1 USD = " + brl + " BRL");
                System.out.println("1 USD = " + eur + " EUR");
